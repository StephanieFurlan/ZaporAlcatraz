...
class Drevo:
    ...
    def koliko_ponikne(self):
        ...
        if self.levo == Drevo() and self.desno == Drevo():
            return self.placa

        else:
           
            print(self.levo, self.placa, self.desno)
            
           
            razlika = -self.levo.koliko_ponikne() - self.desno.koliko_ponikne() + self.placa
            print(razlika)
            if razlika < 0:
                ponikne = ponikne + razlika
                print(razlika)
            return ponikne
        return ponikne
# =====================================================================@003420=
...
def _validate_current_file():
    ...
    try:
        ...
        token = 'Token faebd49a95425c6e038342727a3141e552abe921'
